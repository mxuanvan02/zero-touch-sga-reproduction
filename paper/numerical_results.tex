...
terms. The proposed framework attains a total of $20.0$~Wh, a
\textbf{20.2\%} reduction relative to CENT ($25.1$~Wh), its closest competitor.
...
$2.3$~Wh, a \textbf{46.2\%} reduction over NON-SEM. Fig.~\ref{fig:energy}
...
\midrule
\textbf{Proposed} & 8.2 & 6.1 & \textbf{3.4} & \textbf{2.3} & \textbf{20.0} \\
...
point ($\approx 20.0$~Wh), well below the CENT baseline ($25.1$~Wh).}
\label{fig:energy}
\end{figure}
...
\midrule
Energy savings (Proposed vs CENT)        & 20.2\% & 18.2\% \\
